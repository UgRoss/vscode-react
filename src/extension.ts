...
export function activate(context: vscode.ExtensionContext) {
  ...
  const disposable = vscode.commands.registerCommand('extension.snippetSearch', async () => {
    ...
    const snippetsArray: Array<[string, Snippet]> = javascriptSnippets.concat(typescriptSnippets);
